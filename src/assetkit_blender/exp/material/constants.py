...
_AK_WRAP_MIRROR = 2
_AK_WRAP_CLAMP = 3
_AK_MINFILTER_UNSPECIFIED = 0
_AK_MINFILTER_NONE = 1
_AK_MINFILTER_NEAREST = 2
_AK_MINFILTER_LINEAR = 3
_AK_MINFILTER_NEAREST_MIPMAP_NEAREST = 5
_AK_MINFILTER_LINEAR_MIPMAP_LINEAR = 8
_AK_MAGFILTER_UNSPECIFIED = 0
_AK_MAGFILTER_NONE = 1
_AK_MAGFILTER_NEAREST = 2
_AK_MAGFILTER_LINEAR = 3
_AK_MIPFILTER_UNSPECIFIED = 0
